      ...
      <div className="grid gap-6 md:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-stone-200 bg-white px-4 py-3 text-sm"
            placeholder="Кошик Provence з паперової лози"
          />
        </label>
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-2xl border border-stone-200 bg-white px-4 py-3 text-sm"
            placeholder="Короткий опис для пошукових систем і соцмереж."
          />
        </label>
      </div>

      <ProductVariantEditor initialVariants={initialValues?.variants} />
